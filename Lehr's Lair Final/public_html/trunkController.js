 ...
 */
    ...
    function function30() {
        ...
        if(level.getItemStatus(31)===false) {
            msg("This feels like a battery. Only if I had a flash light, I would be able to make some light.");
        }
    ...
    function endGame() {
		...
		msg("Whoof. I made it out alive. Thank god! It smelt like failing grades in there.");
